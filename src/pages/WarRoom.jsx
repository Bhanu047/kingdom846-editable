...
export default function WarRoom() {
  ...
  return <div className="space-y-5">
    <Panel glow className="gold-corners overflow-hidden"><div className="relative rounded-xl border border-gold/15 bg-gradient-to-br from-gold/10 via-ink-2/80 to-ink p-5"><div className="absolute inset-0 opacity-20 pointer-events-none" style={{backgroundImage:'radial-gradient(circle at 50% 0%, rgba(212,175,55,.45), transparent 45%)'}}/><div className="relative"><RoyalSectionHeader icon="swords" eyebrow="[RYO] SHONI · PRIVATE COMMAND" title="War Room"/><p className="mt-2 max-w-2xl text-sm text-parchment/55">Coordinate synchronized whale rallies from one royal command table. Save march times, select the rally team, and use the live call sequence so every march lands together.</p></div></div></Panel>
